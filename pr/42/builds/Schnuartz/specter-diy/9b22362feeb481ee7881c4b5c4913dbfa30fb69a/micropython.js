...
var ASM_CONSTS = {
 ...
 9238520: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 9238603: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 9238672: () => { return window.innerWidth; },  
 9238702: () => { return window.innerHeight; }
};
